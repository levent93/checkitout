...
<table id="ankete" class="table table-striped table-hover">
	<thead>
		<tr>
			<th>Naziv</th>
			<th>Uneo</th>
		...
		<?php foreach ($tabela as $red) : ?>
			<?php if (isset($id) && $id == $red->id) : ?>
				<tr>
					...
					<td>
						<button class="btn btn-xs btn-link" onclick="vrati_podatke('ankete', '');">
			...
			<?php else : ?>
				<tr>
					...
					<td>
						<button id="<?php echo $red->id; ?>" onclick="vrati_podatke('ankete', this.id);" class="btn btn-xs btn-link">
